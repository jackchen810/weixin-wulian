...
const apiMall = 'https://dsjiaqi.cn'
//本地调试可以修改host达到域名重定向到本地的目的
// C:\Windows\System32\drivers\etc\hosts
// 127.0.0.1       dsjiaqi.cn
...
//new add
const getDeviceRealData = (params) => wxRequest(params, apiMall + '/api/gateway/data/list');
const getDeviceMinuteData = (params) => wxRequest(params, apiMall + '/api/gateway/minute1/list');


const getDeviceArray = (params) => wxRequest(params, apiMall + '/api/device/manage/array');
const getDeviceInfo = (params) => wxRequest(params, apiMall + '/api/device/manage/list');
const getProjectArray = (params) => wxRequest(params, apiMall + '/api/project/manage/array');
const getProjectInfo = (params) => wxRequest(params, apiMall + '/api/project/manage/list');


const getDevModuleStatus = (params) => wxRequest(params, apiMall + '/api/module/run/status');
const getDevModuleStatusStats = (params) => wxRequest(params, apiMall + '/api/module/status/stats');

//get image
const getImage = (params) => wxRequest(params, apiMall + '/image');
